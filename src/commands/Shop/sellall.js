...
$wait[1s]
You sold **$sum[$getGlobalUserVar[foxStock];$sum[$getGlobalUserVar[deerStock];$getGlobalUserVar[mooseStock];$getGlobalUserVar[rabbitStock];$getGlobalUserVar[Stone;$authorID];$getGlobalUserVar[Gold;$authorID];$getGlobalUserVar[Diamond;$authorID]]] items** for $getVar[Coi]**$sum[$multi[$getGlobalUserVar[Stone;$authorID];3];$multi[$getGlobalUserVar[Gold;$authorID];20];$multi[$getGlobalUserVar[Diamond;$authorID];30];$multi[$getGlobalUserVar[foxStock;$authorID];50];$multi[$getGlobalUserVar[deerStock;$authorID];75];$multi[$getGlobalUserVar[mooseStock;$authorID];100];$multi[$getGlobalUserVar[rabbitStock;$authorID];125]]**
