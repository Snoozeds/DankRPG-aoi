module.exports = {
	...
	$description[It has **1HP**!\n You fight it, dealing **1 ATK**. It dies, and you earn <:RPGCoin:855767372534906920>**$random[5;10]**.
	...
	$else
	$title[A new monster has spawned!]
	$description[It has **2HP**!\n You fight it, dealing **2 ATK**. It dies, and you earn <:RPGCoin:855767372534906920>**$random[15;20]**.
	...
	$else
	$title[A new monster has spawned!]
	$description[It has **3HP**!\n You fight it, dealing **3 ATK**. It dies, and you earn <:RPGCoin:855767372534906920>**$random[20;25]**.
	...
	$else
	$title[A new monster has spawned!]
	$description[It has **4HP**!\n You fight it, dealing **4 ATK**. It dies, and you earn <:RPGCoin:855767372534906920>**$random[25;30]**.
