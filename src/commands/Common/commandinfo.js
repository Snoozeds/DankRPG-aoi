...
**Command Name**: $commandInfo[$message;name]
**Aliases**: $replaceText[$replaceText[$checkCondition[$commandInfo[$message;aliases]==];true;**N/A**;1];false;$commandInfo[$message;aliases];1]
;1]]
