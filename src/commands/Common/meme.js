...
$footer[1;From r/$randomText[dankmemes;memes]]
...
$createObject[$jsonRequest[https://cryptons-api.herokuapp.com/api/v1/reddit?subreddit=$randomText[dankmemes;memes]]]
$endIf
$if[$checkContains[$getObjectProperty[image];https://v.redd.it/]==false]
$createObject[$jsonRequest[https://cryptons-api.herokuapp.com/api/v1/reddit?subreddit=$randomText[dankmemes;memes]]]
$endIf
